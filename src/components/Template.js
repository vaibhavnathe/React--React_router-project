    ...
    return (
        <div className="flex justify-between w-11/12 max-w-[1160px] py-12 mx-auto gap-x-12 gap-y-0">
            ...
            <div className="w-11/12 max-w-[450px]">
                ...
                <button className="w-full flex justify-center items-center rounded-[8px] px-[12px] py-[8px]
                                font-medium gap-x-2 mt-6 text-richblack-100 border border-richblack-700">
                    <FcGoogle/>
